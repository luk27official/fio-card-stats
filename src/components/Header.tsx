...
function Header({ onHelpClick, onExampleClick, onCategoryManagerClick }: HeaderProps) {
  return (
    <header className="app-header">
      ...
      <nav className="nav-links">
        ...
        <a
          href="https://github.com/luk27official/fio-card-stats"
          target="_blank"
        ...
        {onCategoryManagerClick && (
          <>
            <span className="nav-separator">|</span>
            <button onClick={onCategoryManagerClick} className="nav-link">
              Categories
            </button>
          </>
        )}
