...
function ResultsSection({ categorizedData, currency, totalSum, shownDetailedCategory, setShownDetailedCategory }: ResultsSectionProps) {
    ...
    return (
        <div className="results-section">
            ...
            <section className="chart-section">
                ...
                <CategoryChart categorizedData={categorizedData} currency={currency} />
            </section>
